                  ...
                  <div class="main-menu-content">
                     <ul>
                        <li class="more-details">
                           <a href="stud_profile"><i class="ti-user"></i>View Profile</a>
                              ...
                              <div class="card">
                                 <div class="card-header">
                                    ...
                                    <div class="">
						                  ...
						                  <?php 
						$cnt = 1;
						if($results = $meeting->meetings("SELECT `meetings`.*, `meetingtype`.`name` FROM `meetings` LEFT JOIN `meetingtype` ON `meetings`.`meetingTypeId`=`meetingtype`.`id` WHERE `meetings`.`attendee`=? OR `meetings`.`attendee`=?", ['students', 'allusers']))
						{
						...
						{       
							?>  
						                    <tr>
						                      ...
						                      <td><a href="stud_meeting_details.php?meetingid=<?php echo $result->id;?>" title="view" class="text-info"><i class="fa fa-eye"></i></a></td>
