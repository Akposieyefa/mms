						...
						{       
							?>  
						                    <tr>
						                      ...
						                      <td><a href="admin_meeting_details.php?meetingid=<?php echo $result->id;?>" title="view" class="text-info"><i class="fa fa-eye"></i></a></td>
						                      <td><?php echo ($result->isActive == 1) ? "<span class='text-success'>upcoming</span>" : "--" ;?></td>
						                      <td>
						                      <a href="#admin_edit_meeting.php?meetingid=<?php echo $result->id;?>" title="edit" class="text-warning"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
						                    <a href="admin_meetings.php?deleteid=<?php echo htmlentities($result->id);?>" title="view" class="text-danger" onclick="return confirm('Are you sure to delete this meeting?')"><i class="fa fa-trash-o"></i></a>
						                    </td>
						                    </tr>
						                    <?php $cnt=$cnt+1; }} ?>
                              ...
                              <div class=" sub_sect2">
                                 ...
                                 <div class="mr">
                                	...
                                	<div class="mt-3">
	                                    ...
	                                    <input type="radio" name="attendess" id="attendess" value="allusers">All Members
	                                    <input type="radio" name="attendess" id="attendess" value="staff">Staff
	                                    <input type="radio" name="attendess" id="attendess" value="students">Students
                                	</div>
