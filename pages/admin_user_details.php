...
$pdo = new Connection;
$users = new Users($pdo);
$user = $users->singleUser([$_GET['userid']]);
...
<div class="pcoded-content">
  ...
  <div class="pcoded-inner-content">
          ...
          <div class="card">
           <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="<?php echo (!empty($user->picture)) ? '../images/'.$user->picture : '../images/avatar.jpg'; ?>" class="rounded-circle" width="150">
                  <div class="mt-3">
                      <h4><?php echo $user->name; ?></h4>
                      <p class="text-secondary mb-1"><?php echo $user->registerationId; ?></p>
                      <p class="text-muted font-size-sm"><?php echo $user->department; ?></p>
    ...
    <div class="col-sm-6">
      ...
      <div class="row">
          <div class="col-sm-3">
            <h6 class="mb-0">IsActive</h6>
          </div>
          <div class="col-sm-9 text-secondary">
            <?php echo ($user->isActive == 1) ? "<span class='text-success'>Active</span>" : "<span class='text-danger'>Inactive</span>"; ?>
          </div>
        </div>
        <hr>
        <div class="row">
    ...
    <div class="col-sm-12">
      <div class="d-flex align-items-center">
        <div class="justify-center-center">
          <a class="btn btn-danger btn-lg" href="admin_user_details.php?deleteid=<?php echo $_GET['userid']; ?>">Delete</a>
        </div>
      </div>
    </div>
  </div>
