  ...
  if (isset($_GET['userid'])) {
	...
	if(isset($_POST["submit"])){
		...
		if($rowEmail>0){
			...
			$sql = $users->create("INSERT INTO users (`name`, `phone`, `department`, `level`, `email`, `gender`, `registerationId`, `password`, `memberType`, `isActive`, `createdBy`) VALUES (?,?,?,?,?,?,?,?,?,?,?)", [$stud_name, $stud_phone, $stud_department, $level, $stud_email, $stud_gender, $studentid, $stud_password, 'Student', '1', 'Admin']);
           ...
           <div class="card-body">
              <form class="row g-3" id="myform" novalidate="" method="post" action="addstudents.php">
	           <div class="col-sm-4">
				...
				<input type="text" name="stud_fname" id="stud_fname" class="form-control" value="<?php echo $user->name; ?>">
			  </div>
			  <div class="col-sm-4">
