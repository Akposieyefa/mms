                           ...
                           <div class="col-md-12 ">
                              <div class=" sub_sect2">
                                 ...
                                 <div class="mt-3">
                                       ...
                                       <input class="form-control" type="text" value="<?php echo $results->venue; ?>" name="venue" id="venue" readonly="true">
                                 </div>
                                 <div class="mt-3">
                                       <label for="greetingtxt" class="form-label">Greeting Text</label>
                                       <input class="form-control" type="text" value="<?php echo $results->greetingText; ?>" id="greetingtxt" readonly="true">
                                 </div>
                                 <div class="mt-3">
                                       <label for="greetingtxt" class="form-label">Agenda</label>
                                       <textarea class="form-control" id="agenda" rows="5" col="3" readonly="true"><?php echo $results->agenda; ?></textarea>
                                 </div>
                                 </form>
                                   <?php endif; ?>
                                 </div>
